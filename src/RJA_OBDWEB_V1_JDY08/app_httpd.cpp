...
int CC2541DD = GPIO_NUM_47; //GPIO14=D5 on NodeMCU/WeMos D1 Mini
int CC2541DC = GPIO_NUM_48; //GPIO4=D2 on NodeMCU/WeMos D1 Mini
int CC2541RESET = GPIO_NUM_12; //GPIO5=D1 on NodeMCU/WeMos D1 Mini
                            ...
                            unsigned short num_cmd_bytes)
{
  ...
  //Added this Line as to prevent triggers from RTOS on stuck routines
...
static esp_err_t page_handler(httpd_req_t *req) {
  ...
  else
  {
    ...
    else if (strstr(value, "js") != NULL)
      httpd_resp_set_type(req, "text/javascript");
    else if (strstr(value, "jpg") != NULL)
      httpd_resp_set_type(req, "image/jpg");
    else if (strstr(value, "png") != NULL)
