...
void setup() {
 ...
 //digitalWrite(PWRC, LOW);
  ...
  // Uncomment if usung CUSTOM JDY08 Firmware with TPMS/Battery Monitoring
  Serial2.begin(115200,SERIAL_8N1,RXD2,TXD2);

 // if uuding esp32-s3 UART0
 // Serial1.begin(9600,SERIAL_8N1,RXD0,TXD0);
 // Serial1.begin(9600);
  

 // Uncomment if using JDY08 with HM10 Firmware + ELM327-BLE timer
...
/*
// Activate this routine to enable BLE-ELM327 using JDY08 with HM10 Firmware
